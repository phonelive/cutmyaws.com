<template>
  <div class="max-w-5xl mx-auto px-6 py-24">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
      <a href="#book" class="bg-gray-950 border border-gray-800 rounded-2xl p-6 text-center block hover:border-brand-500/50 transition-colors">
    ...
    <a href="#book" class="max-w-2xl mx-auto bg-gray-950 border border-gray-800 rounded-2xl p-8 block hover:border-brand-500/50 transition-colors">
